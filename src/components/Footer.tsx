...
import { GraduationCap, MapPin, Phone, Users, Mail } from "lucide-react";
...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white pt-20 pb-10 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_rgba(255,255,255,0.08),_transparent_70%)]"></div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-12">
        ...
        >
          ...
          <p className="text-blue-100 leading-relaxed">
            L’école <strong>Maman Coumba</strong> s’engage à offrir une éducation d’excellence, 
            du préscolaire à la terminale, dans un environnement qui favorise 
            l’éveil intellectuel, moral et social de chaque élève.
          </p>
          <p className="text-sm text-blue-200 italic">« Excellence et Innovation »</p>
        </motion.div>
        ...
        >
          ...
          <ul className="space-y-4 text-blue-100">
            ...
            <li className="flex items-start gap-3">
              ...
              <span>Directeur Général : <strong>Mr Ousmane Niassy</strong></span>
            </li>
            <li className="flex items-start gap-3">
        ...
        >
          ...
          <ul className="space-y-3 text-blue-100">
            <li>🎓 <strong>Niveaux :</strong> Du Préscolaire à la Terminale</li>
            <li>📚 <strong>Programme :</strong> Conforme au système éducatif sénégalais</li>
            <li>🕐 <strong>Horaires :</strong> 
              <br />Lundi - Vendredi : 8h00 à 17h00 
              <br />Samedi : 8h00 à 13h00
            </li>
          </ul>
        </motion.div>
      </div>
